...
function onPaddingChanged(data) {
    ...
    var style = data.object;
    var valueSource = style._getValueSource(exports.paddingProperty);
    try {
        style._beginUpdate();
        style._setValue(exports.paddingTopProperty, thickness.top, valueSource);
        style._setValue(exports.paddingRightProperty, thickness.right, valueSource);
        style._setValue(exports.paddingBottomProperty, thickness.bottom, valueSource);
        style._setValue(exports.paddingLeftProperty, thickness.left, valueSource);
    }
    finally {
        style._endUpdate();
    }
...
function onMarginChanged(data) {
    var thickness = parseThickness(data.newValue);
    var style = data.object;
    var valueSource = style._getValueSource(exports.marginProperty);
    try {
        style._beginUpdate();
        style._setValue(exports.marginTopProperty, thickness.top, valueSource);
        style._setValue(exports.marginRightProperty, thickness.right, valueSource);
        style._setValue(exports.marginBottomProperty, thickness.bottom, valueSource);
        style._setValue(exports.marginLeftProperty, thickness.left, valueSource);
    }
    finally {
        style._endUpdate();
    }
...
exports.fontInternalProperty = new styleProperty.Property("_fontInternal", "_fontInternal", new observable.PropertyMetadata(font.Font.default, AffectsLayout, null, null, font.Font.equals), font.Font.parse);
exports.textAlignmentProperty = new styleProperty.Property("textAlignment", "text-align", new observable.PropertyMetadata(undefined, AffectsLayout | observable.PropertyMetadataSettings.Inheritable), converters.textAlignConverter);
exports.minWidthProperty = new styleProperty.Property("minWidth", "min-width", new observable.PropertyMetadata(0, AffectsLayout, null, isMinWidthHeightValid), converters.numberConverter);
exports.minHeightProperty = new styleProperty.Property("minHeight", "min-height", new observable.PropertyMetadata(0, AffectsLayout, null, isMinWidthHeightValid), converters.numberConverter);
exports.nativeLayoutParamsProperty = new styleProperty.Property("nativeLayoutParams", "nativeLayoutParams", new observable.PropertyMetadata({
    width: -1,
    height: -1,
    leftMargin: 0,
    topMargin: 0,
...
exports.nativePaddingsProperty = new styleProperty.Property("paddingNative", "paddingNative", new observable.PropertyMetadata({ top: 0, right: 0, bottom: 0, left: 0 }, null, null, null, thicknessComparer));
exports.widthProperty = new styleProperty.Property("width", "width", new observable.PropertyMetadata(Number.NaN, AffectsLayout, onLayoutParamsChanged, isWidthHeightValid), converters.numberConverter);
exports.heightProperty = new styleProperty.Property("height", "height", new observable.PropertyMetadata(Number.NaN, AffectsLayout, onLayoutParamsChanged, isWidthHeightValid), converters.numberConverter);
exports.verticalAlignmentProperty = new styleProperty.Property("verticalAlignment", "vertical-align", new observable.PropertyMetadata(enums.VerticalAlignment.stretch, AffectsLayout, onLayoutParamsChanged));
exports.horizontalAlignmentProperty = new styleProperty.Property("horizontalAlignment", "horizontal-align", new observable.PropertyMetadata(enums.HorizontalAlignment.stretch, AffectsLayout, onLayoutParamsChanged));
...
exports.marginLeftProperty = new styleProperty.Property("marginLeft", "margin-left", new observable.PropertyMetadata(0, AffectsLayout, onLayoutParamsChanged, isMarginValid), converters.numberConverter);
exports.marginRightProperty = new styleProperty.Property("marginRight", "margin-right", new observable.PropertyMetadata(0, AffectsLayout, onLayoutParamsChanged, isMarginValid), converters.numberConverter);
exports.marginTopProperty = new styleProperty.Property("marginTop", "margin-top", new observable.PropertyMetadata(0, AffectsLayout, onLayoutParamsChanged, isMarginValid), converters.numberConverter);
exports.marginBottomProperty = new styleProperty.Property("marginBottom", "margin-bottom", new observable.PropertyMetadata(0, AffectsLayout, onLayoutParamsChanged, isMarginValid), converters.numberConverter);
...
exports.paddingLeftProperty = new styleProperty.Property("paddingLeft", "padding-left", new observable.PropertyMetadata(0, AffectsLayout, onPaddingValueChanged, isPaddingValid), converters.numberConverter);
exports.paddingRightProperty = new styleProperty.Property("paddingRight", "padding-right", new observable.PropertyMetadata(0, AffectsLayout, onPaddingValueChanged, isPaddingValid), converters.numberConverter);
exports.paddingTopProperty = new styleProperty.Property("paddingTop", "padding-top", new observable.PropertyMetadata(0, AffectsLayout, onPaddingValueChanged, isPaddingValid), converters.numberConverter);
exports.paddingBottomProperty = new styleProperty.Property("paddingBottom", "padding-bottom", new observable.PropertyMetadata(0, AffectsLayout, onPaddingValueChanged, isPaddingValid), converters.numberConverter);
exports.visibilityProperty = new styleProperty.Property("visibility", "visibility", new observable.PropertyMetadata(enums.Visibility.visible, AffectsLayout, onVisibilityChanged, isVisibilityValid), converters.visibilityConverter);
