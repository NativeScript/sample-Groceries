...
* **c.** Save both the `app/app.component.ts` and `app/login/login.component.css` files. You should see the following display on your device.
...
* **c.** Open your `app/login/login.component.css` file, and add the following CSS code under the existing `FlexboxLayout` and `StackLayout` selectors.
...
* **d.** Save your `app/app.css`, `app/app.component.ts`, and `app/login/login.component.css` files. You should see the following UI on your device.
...
* **b.** Save your `app/app.component.ts` file. You should see the following new image on your device.
